 ...
 * S3 文件操作
 */
public class UploadFileS3Utils {
     ...
     * 存储桶名称
     */
    private static final String BUCKET_NAME = "定义的桶名称";
    /**
     * 创建s3对象
     */
    ...
    private static void uploadFile() throws IOException {
        ...
        String filePath = updateLoadFile(multipartFile, null, "test");
